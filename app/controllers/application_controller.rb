class ApplicationController < ActionController::Base
  ...
  NOTE = [
    ...
    { id: 8, degree: "I", function: "Tm", interval: 0, scale_id: 2, triad_id: 3, seventh_id: 7, tensions:[] },
    { id: 9, degree: "II", function: "sm", interval: 2, scale_id: 2, triad_id: 4, seventh_id: 9, tensions:[] },
    { id: 10, degree: "III", function: "tm", interval: 3, scale_id: 2, triad_id: 2, seventh_id: 6, tensions:[] },
    { id: 11, degree: "IV", function: "Sm", interval: 5, scale_id: 2, triad_id: 3, seventh_id: 7, tensions:[] },
    { id: 12, degree: "V", function: "Dm", interval: 7, scale_id: 2, triad_id: 3, seventh_id: 7, tensions:[] },
    { id: 13, degree: "VI", function: "sm", interval: 8, scale_id: 2, triad_id: 2, seventh_id: 6, tensions:[] },
    { id: 14, degree: "VII", function: "sm", interval: 10, scale_id: 2, triad_id: 2, seventh_id: 5, tensions:[] },
  ...
  CHORD = [
    ...
    { id: 10, type: "dim7", notes: [0,3,6,9], category: "dim" },
    { id: 11, type: "6", notes: [0,4,7,9], category: "seven" },
    { id: 12, type: "m6", notes: [0,3,7,9], category: "seven" },
    { id: 13, type: "sus2", notes: [0,2,5], category: "sus" },
    { id: 14, type: "7sus2", notes: [0,2,7,10], category: "sus" },
    { id: 15, type: "sus4", notes: [0,5,7], category: "sus" },
    { id: 16, type: "7sus4", notes: [0,5,7,10], category: "sus" },
    { id: 17, type: "aug", notes: [0,4,8], category: "aug" },
    { id: 18, type: "aug7", notes: [0,4,8,10], category: "aug" },
    { id: 18, type: "aug△7", notes: [0,4,8,11], category: "aug" },
    { id: 19, type: "add9", notes: [0,4,7,14], category: "extention" },
    { id: 20, type: "madd9", notes: [0,3,7,14], category: "extention" },
    { id: 21, type: "9", notes: [0,4,7,10,14], category: "extention" },
    { id: 22, type: "7(+9)", notes: [0,4,7,10,15], category: "extention" },
    { id: 23, type: "7(-9)", notes: [0,4,7,10,13], category: "extention" },
    { id: 24, type: "△9", notes: [0,4,7,11,14], category: "extention" },
    { id: 25, type: "m9", notes: [0,3,7,10,14], category: "extention" },
    { id: 26, type: "m△9", notes: [0,3,7,11,14], category: "extention" },
    { id: 27, type: "9(-5)", notes: [0,4,6,10,14], category: "extention" },
    { id: 28, type: "69", notes: [0,4,7,9,14], category: "extention" },
    { id: 29, type: "9sus4", notes: [0,5,7,10,14], category: "extention" },
    { id: 30, type: "7(11)", notes: [0,4,7,10,17], category: "extention" },
    { id: 30, type: "7(+11)", notes: [0,4,7,10,18], category: "extention" },
    { id: 31, type: "m7(-5,11)", notes: [0,3,6,10,17], category: "seven" },
    { id: 32, type: "11", notes: [0,4,7,10,14,17], category: "extention" },
    { id: 33, type: "m11", notes: [0,3,7,10,14,17], category: "extention" },
    { id: 34, type: "7(13)", notes: [0,4,7,10,14,21], category: "extention" },
    { id: 35, type: "△9(+11)", notes: [0,4,7,10,14,18], category: "extention" },
    { id: 36, type: "9(+11)", notes: [0,4,7,10,14,18], category: "extention" },
    { id: 37, type: "13", notes: [0,4,7,10,14,17,21], category: "extention" },
  ]
